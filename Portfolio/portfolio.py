...
def main():
        ...
        with st.sidebar:
            ...
            if st.button("Github 👨‍💻"):
                ...
                div = Div(text=html)
                st.bokeh_chart(div)  
            with open("C:/Users/varun/OneDrive/Desktop/Portfolio/Aditya Bachu Resume.pdf", "rb") as file:
...
def show_work_experience():
    image = Image.open('C:/Users/varun/OneDrive/Desktop/Portfolio/Images/GDSC (3).jpg')
